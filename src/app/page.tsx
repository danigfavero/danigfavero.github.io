          ...
          <div className="mb-12">
            ...
            <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Dani G. Favero
                ...
                Hi there! I&apos;m a passionate developer who loves building things with code. 
                When I&apos;m not coding, you can find me exploring new technologies, contributing to open source, 
                or sharing my thoughts on software development.
              </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Full-stack development, open source contributions, and sharing knowledge through writing and speaking.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Modern web technologies, cloud infrastructure, and building scalable applications.
              </p>
            </div>
          </div>
