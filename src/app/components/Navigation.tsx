    ...
    <nav className="bg-gray-50 pt-4 2xl:pt-6" aria-label="Main navigation">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12">
        <div className="max-w-6xl 2xl:max-w-[90%] mx-auto">
          ...
          <div className="flex space-x-6 sm:space-x-8 lg:space-x-16 2xl:space-x-20" role="navigation" aria-label="Site sections">
            <Link 
              href="/blog" 
              className={`${
                pathname === '/blog' 
              ...
              } transition-colors font-bold font-poppins text-sm sm:text-base 2xl:text-lg`}
            ...
            <Link 
              ...
              className="text-black hover:text-gray-700 transition-colors font-bold font-poppins flex items-center gap-1 text-sm sm:text-base 2xl:text-lg"
